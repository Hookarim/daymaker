        ...
        {!sent ? (
          <form onSubmit={handleLogin}>
            ...
            <p style={{ marginTop: 20, fontSize: 12, color: '#7E8C82', textAlign: 'center', lineHeight: 1.5 }}>
              Wir senden dir einen Login-Link per E-Mail. Keine Passwörter, kein Stress.
            </p>
          </form>
        ) : (
          <div style={{
            padding: 20, background: '#16201A',
            border: '1px solid #7DA888', borderRadius: 12,
            textAlign: 'center'
          }}>
            <div style={{ fontSize: 32, marginBottom: 8 }}>✉️</div>
            <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8 }}>Check deine E-Mails</h2>
            <p style={{ color: '#B8C4B8', fontSize: 13, lineHeight: 1.5, marginBottom: 16 }}>
              Wir haben einen Login-Link an <strong>{email}</strong> geschickt.
              Tap auf den Link in der E-Mail, um dich anzumelden.
            </p>
            <button
              ...
              style={{
                ...
                border: '1px solid #7DA88866', borderRadius: 10,
